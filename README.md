...
```
github "socketio/socket.io-client-swift" ~> 5.3.0 # Or latest version
```
...
pod 'Socket.IO-Client-Swift', '~> 5.3.0' # Or latest version
```
...
```
github "socketio/socket.io-client-swift", "v5.3.0", :files => "Source/*.swift" # Or latest version
```
