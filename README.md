...
```
github "socketio/socket.io-client-swift" ~> 4.0.1 # Or latest version
```
...
pod 'Socket.IO-Client-Swift', '~> 4.0.1' # Or latest version
```
...
```
github "socketio/socket.io-client-swift", "v4.0.1", :files => "SocketIOClientSwift/*.swift" # Or latest version
```
