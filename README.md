...
```
github "socketio/socket.io-client-swift" ~> 5.2.2 # Or latest version
```
...
pod 'Socket.IO-Client-Swift', '~> 5.2.2' # Or latest version
```
...
```
github "socketio/socket.io-client-swift", "v5.2.2", :files => "Source/*.swift" # Or latest version
```
